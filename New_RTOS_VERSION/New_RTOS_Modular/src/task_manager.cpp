...
void TaskManager::blynkTask(void* parameter) {
    while (g_blynkManager != nullptr && systemRunning) {
...
void TaskManager::sensorTask(void* parameter) {
    while (g_sensorManager != nullptr && systemRunning) {
...
void TaskManager::actuatorTask(void* parameter) {
    while (g_actuatorManager != nullptr && g_sensorManager != nullptr && systemRunning) {
        g_actuatorManager->updateActuators(
            ...
            isDay, // Global variable from blynk_manager
            AC     // Global variable from blynk_manager
        );
...
void TaskManager::displayTask(void* parameter) {
    while (g_displayManager != nullptr && systemRunning) {
