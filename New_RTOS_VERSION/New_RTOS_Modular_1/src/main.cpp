...
// External declaration for global BlynkManager pointer
extern BlynkManager* globalBlynkManager;
...
void setup() {
    ...
    globalBlynkManager = blynkManager; // Set global pointer for Blynk callbacks
